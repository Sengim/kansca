...
class ReadASCADf:
    ...
    def rescale(self, reshape_to_cnn):
        self.x_profiling = np.array(self.x_profiling, dtype='double')
        self.x_validation = np.array(self.x_validation, dtype='double')
        self.x_attack = np.array(self.x_attack, dtype='double')
