...
#model.plot()
model.train(new_dataset,opt="Adam", steps=20000, device=model.device,lamb=0, lamb_l1=0.2,lamb_entropy=0.2,  lr=1e-3,batch=200, loss_fn=torch.nn.CrossEntropyLoss())
#model.plot(beta=10)
